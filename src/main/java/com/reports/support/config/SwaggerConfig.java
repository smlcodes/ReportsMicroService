package com.reports.support.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
					.apis(RequestHandlerSelectors.basePackage("com.reports.api"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("reports-services-2023 Rest API")
				.description("Internal REST API for reports-services-2023")
				.version("1.0")
				.build();
    }
